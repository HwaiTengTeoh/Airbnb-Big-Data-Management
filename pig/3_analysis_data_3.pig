...
avgprice_property = order avgprice_property by avg_price DESC;
top10_avgprice_property = limit avgprice_property 10;
/*dump top10_avgprice_property;*/

store top10_avgprice_property into '/bdm/SINGAPORE/output/pig/output_p3_3';
