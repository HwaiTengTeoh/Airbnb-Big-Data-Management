...
listings = foreach load_listings 
		generate listing_id..name,
			 ...
			 TOKENIZE(host_identity_verified,',') as host_identity_verified,
			 neighborhood..beds,
			 TOKENIZE(amenities,',') as amenities,
			 (float)REPLACE(REPLACE(price,'[$]',''),',','') as price,
			 minimum_nights..reviews_per_month,
			 GetYear(host_since) as start_year; /* extra */
/*
check_listings = limit listings 5;
dump check_listings;
*/
...
/*
check_calendar = limit calendar 5;
dump check_calendar;
*/
